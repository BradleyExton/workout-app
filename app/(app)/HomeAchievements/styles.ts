export const wrapper = "flex flex-col gap-2";
export const kicker = "kicker text-gold";
// Scrolls rather than squeezes: three chips sharing one row truncated
// titles mid-word ("10,000 KG …"), which is worse than a peek-and-swipe.
