...
export const screen =
  "fixed inset-0 z-50 overflow-y-auto bg-void [background-image:radial-gradient(120%_60%_at_50%_-10%,#2a1550_0%,transparent_60%)] animate-fade-in";
export const inner =
...
// below it.
// Everything below the backdrop arrives on a stagger (see STAGGER_MS in
// index.tsx) so the screen reads top-to-bottom instead of landing at once:
// what you did, then what you earned. Each block carries `animate-rise`
// and gets its delay from the component.
export const burst = "text-center py-6 mt-auto animate-rise";
...
export const breakdownCard = "card-volt px-4 py-1.5 animate-rise";
...
export const prCard = "card-volt p-3 flex flex-col gap-2 animate-rise";
...
// The one place the app spends `celebrate` timing: badges land last, one
// after another, and their gold glow blooms only as each settles.
export const badgeRow =
  "rounded-2xl border border-gold/40 bg-panel shadow-glow-gold px-3.5 py-3 flex items-center gap-3 animate-badge-drop";
...
export const cta = "mt-auto pt-4 animate-rise";
